                                    ...
                                    <form enctype= "multipart/form-data"  method="post" class="" action="{{ url('/backyard/TourGuide/edit/'. $tourguide->id) }}" >
                                     ...
                                     <div class="row">
                                          <div class="col-md-3">
                                            <div class="form-group">
                                                  <div class="main-img-preview">
                                                    <img class="thumbnail img-preview-1" src="http://homestead.test/images/{{$tourguide->img_cv}}" " title="Preview Logo">
                                                  </div>
                                      ...
                                      <div class="col-md-3">
                                          <div class="form-group">
                                                  <div class="main-img-preview">
                                                    <img class="thumbnail img-preview-2" src="http://homestead.test/images/{{$tourguide->img_cd}}" title="Preview Logo">
                                                  </div>
                                                  <div class="input-group m-t-5">
                                      ...
                                      <div class="col-md-3">
                                          <div class="form-group">
                                                  <div class="main-img-preview">
                                                    <img class="thumbnail img-preview-3" src="http://homestead.test/images/{{$tourguide->img_full}}" title="Preview Logo">
                                                  </div>
                                                  <div class="input-group m-t-5">
