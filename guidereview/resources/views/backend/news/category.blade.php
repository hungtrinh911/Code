            ...
            <div class="col-lg-4 col-form">
                <div class="card-box">
                    ...
                    <form method="post" class="form-add d-none"
                          action="{{ action('Backend\NewsController@addCategory') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <select id="parent_id" name="parent_id" class="selectpicker show-tick"
                                ...
                                @foreach(\App\NewsCategory::tree('', true) as $item)
                    ...
                    <form method="post" class="form-edit d-none"
                          action="{{ action('Backend\NewsController@editCategory', array('id', $term->id)) }}">
                        {{ csrf_field() }}
                        <input type="hidden" id="id" name="id" value="{{ $term->id }}">
            ...
            <div class="col-lg-8 col-grid">
                <div class="card-box">
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach(\App\NewsCategory::tree('', false) as $item)
                            <tr>
                                {{--<th scope="row">1</th>--}}
                                <td>{{ $item->name }}</td>
                                <td>{{ $item->slug }}</td>
                                <td class="actions">
                                    @if (Auth::user()->can('edit-news_category'))
                                        <a href="{{ action('Backend\NewsController@showEditCategoryForm', array('id'=>$item->id)) }}"
                                    ...
                                    @if (Auth::user()->can('delete-news_category'))
                                        <a href="javascript:;"
                                           ...
                                           data-href="{{ action('Backend\NewsController@deleteCategory', array('id'=>$item->id)) }}">
