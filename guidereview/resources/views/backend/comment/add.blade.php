                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <hr style="padding:10px 0 2px 0;">
                             <textarea name="locale_1" id="locale_1" class="summernote">{{$tourguides->locale_1}}</textarea>
                          </div>
                            <div class="form-group">
                               <div>
                                     <button type="submit" class="btn btn-primary waves-effect waves-light" name="btn_role">
                     ...
                     <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <hr>
                           <textarea name="locale_2" id="locale_2" class="summernote">{{$tourguides->locale_2}}</textarea>
                          </div>
                        </div> 
                     </div>
