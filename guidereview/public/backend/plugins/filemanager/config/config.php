...
$config = array(
	...
	*******************/
	...
	'fixed_path_from_filemanager'             => array( '../../../thumbs/100x100/', '../../../thumbs/400x300/' ), //fixed path of the image folder from the current position on upload folder
	...
	'fixed_image_creation_width'              => array( 100, 400 ), //width of image
	'fixed_image_creation_height'             => array( 100, 300 ), //height of image
	/*
	#             $option:     0 / exact = defined size;
	#                          1 / portrait = keep aspect set height;
	#                          2 / landscape = keep aspect set width;
